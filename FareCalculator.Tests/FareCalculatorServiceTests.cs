...
namespace FareCalculator.Tests
{
    ...
    public class FareCalculatorServiceTests
    {
        ...
        public void CalculateFare_UberX_NegativeDistance_ShouldThrowException()
        {
            ...
            // Act
            _fareCalculatorService.CalculateFare(vehicle, distance);
        ...
        /// Dado que o usuário selecionou UberX como o tipo de veículo
        /// E o usuário especificou 3 passageiros
        /// Quando a distância for zero
        /// Então o sistema deve lançar uma exceção indicando que a distância é inválida.
        /// </summary>
        [TestMethod]
        public void CalculateFare_UberX_ZeroDistance_ShouldThrowException()
        {
            // Arrange
            var uberRide = new UberX { Passengers = 3 };
            var distance = 0;

            // Act & Assert
            Assert
                .ThrowsException<ArgumentOutOfRangeException>(() => _fareCalculatorService.CalculateFare(uberRide, distance));
        }
    }
}
